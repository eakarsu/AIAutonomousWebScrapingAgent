...
// v0 scaffold for: AI selector learning from HTML samples producing CSS / XPath
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-ai-selector-learning-html-samples/run.

export default function AiSelectorLearningHtmlSamplesPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-selector-learning-html-samples/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>AI selector learning from HTML samples producing CSS / XPath</h1>
